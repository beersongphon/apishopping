<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$sql = "INSERT INTO tb_product (product_name, brand_id, category_id, product_price, product_discount, product_quantity, product_description)
	 VALUES ('$product_name', '$brand_id', '$category_id', '$product_price', '$product_discount', '$product_quantity', '$product_description')";
